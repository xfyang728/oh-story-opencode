...
### 角引号「」
**对话和引用必须用半角双引号 `""`（U+201C/U+201D）**，禁止使用角引号「」（U+300C/U+300D）。角引号在中文网文阅读体验中视觉辨识度低，且 AI 生成文本高频使用角引号替代正确双引号。
...
| 破折号「——」 | 逗号/句号/冒号 | "他推开门——屋里空无一人" → "他推开门。屋里空无一人" |
| 双连字符「--」 | 逗号/句号/冒号 | 同上 |
| 角引号「」「」 | 半角双引号 "" | 「你来了」→ "你来了" |
