...
三种实证情绪拍型（切换率实证区间 0.40-0.53），拆解时识别对标书引擎、写作端按引擎选拍型：

| 引擎 | 拍型 | 适用题材 | 特征 |
|------|------|----------|------|
| 高压权谋 | 压三爽一 | 权谋/悬疑/商战 | 紧张+压抑合计过半，长跑蓄力后短促爆发 |
| 升级流换挡 | 低开高走·章尾换挡 | 升级流/武道 | 压抑蓄力开场→温情/喜剧插播→爽/热血收尾，章尾钩子必换挡 |
| 经营喜剧 | 日常喜剧缓冲 | 经营文/种田文 | 轻松独大、切换率最低，日常循环造安稳感，危机只是调味 |
...
- 同型爽点循环 ≤3 次须换形态或换反应层结构，否则边际递减（实证：9 循环中 6 个同构致爽感衰减）
- 反应层「标准件＋变奏件」交替：标准件打直球（辱骂→呆滞→自扇→谄媚四段式），变奏件玩递进变奏（三级反应中途换新组合）；同构反应层不连用
...
写书设定阶段明确感情线档位，避免末卷未闭合：

| 档位 | 说明 | 适用 |
|------|------|------|
| 无 | 明示非感情线，全书不开感情线 | 经营文/纯升级流 |
| 极简器物传情 | 少写正面互动，以器物承载情感（情书熔入固件式），克制且完成度高 | 权谋/事业流 |
| 多线浅 | 多条感情线并行浅写——设定阶段须规划各线闭合点，否则末卷集体未闭合 | 后宫/群像 |
...
| 桥段 | 机制 |
|------|------|
| 数字权威演出 | 参数/数据当台词（31毫欧/85℃/营收数字），用精确数字替代形容词建立权威 |
| 经济细节压迫 | 具体经济细节制造生存压迫（九出十三归、三十块大洋） |
| 亮牌反应层四段式 | 辱骂→呆滞→自扇→谄媚四段递进，篇幅比约 3.2:1 |
| 当众验证仪式场 | 公开场合＋公认标尺量化验证（庭审直播/发布会/比武），必带观众席与实时舆论反馈 |
